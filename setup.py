...
INSTALL_REQUIRES = ['numpy', 'scipy', 'pandas', 'scikit-learn>=0.22', 'joblib',
                    ...
                    'xarray', 'category_encoders', 'xgboost', 'lightgbm',
                    'catboost', 'skrub>=0.2', 'click_config_file', 'holidays',
                    'hebo @ git+https://github.com/kegl/HEBO.git@sparse_grid_space#subdirectory=HEBO']
EXTRAS_REQUIRE = {
