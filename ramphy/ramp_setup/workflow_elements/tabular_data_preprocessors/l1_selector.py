...
selector_C = Hyperparameter(dtype="float", default=0.0, values=[0.001, 0.01, 0.1, 1, 10, 100, 1000])
# RAMP END HYPERPARAMETERS

SELECTOR_C = int(selector_C)
...
class DataPreprocessor(BaseDataPreprocessor):
    ...
    def fit(
        ...
        print(f"Dropped feature: {dropped_features}")
